...
locations_by_region = {
    'Sacred Ordalia Grove': {
        ...
        'Vitality Fragment 3 - Sacred Ordalia Grove': LocationData(41, vitality_fragment=True),
        ...
        'Ivory Bug 3 - Sacred Ordalia Grove': LocationData(58, ivory_bug=True),
        'Ivory Bug 4 - Sacred Ordalia Grove': LocationData(59, ivory_bug=True),
    },
    ...
    'Karst City': {
        ...
        'Vitality Fragment 1 - Karst City': LocationData(43, vitality_fragment=True),
        'Vitality Fragment 2 - Karst City': LocationData(44, vitality_fragment=True),
        'Ivory Bug 1 - Karst City': LocationData(60, ivory_bug=True),
        'Ivory Bug 2 - Karst City': LocationData(61, ivory_bug=True),
    },
    ...
    'Subterranean Grave': {
        ...
        'Dirty Shroom': LocationData(24),
        'Boss - Derelict Frida': LocationData(33, boss=True),
        'Vitality Fragment - Subterranean Grave': LocationData(45, vitality_fragment=True),
        'Ivory Bug - Subterranean Grave': LocationData(62, ivory_bug=True),
    ...
    'Cinder Chambers': {
        ...
        'Vitality Fragment 1 - Cinder Chambers': LocationData(48, vitality_fragment=True),
        'Vitality Fragment 2 - Cinder Chambers': LocationData(49, vitality_fragment=True),
        'Ivory Bug 1 - Cinder Chambers': LocationData(63, ivory_bug=True),
        'Ivory Bug 2 - Cinder Chambers': LocationData(64, ivory_bug=True),
        'Ivory Bug 3 - Cinder Chambers': LocationData(65, ivory_bug=True),
        'Crest Fragment - Cinder Chambers': LocationData(77),
    },

    'Frore Ciele': {
        'Crest Fragment - Frore Ciele': LocationData(79),
        'Vitality Fragment - Frore Ciele': LocationData(42, vitality_fragment=True),
    },

    'Whiteleaf Memorial Park': {
        'Shop - Dull Pearl': LocationData(13),
        'Bellflower - Whiteleaf Memorial Park': LocationData(22),
        'Cat Sphere': LocationData(25),
        'Boss - Lubella, the Witch of Decay 2': LocationData(35, boss=True),
        'Vitality Fragment - Whiteleaf Memorial Park': LocationData(47, vitality_fragment=True),
    ...
    'Royal Pinacotheca': {
        ...
        'Ivory Bug 2 - Royal Pinacotheca': LocationData(72, ivory_bug=True),
        'Ivory Bug 3 - Royal Pinacotheca': LocationData(73, ivory_bug=True),
    },

    'Karst Castle': {
        'Cath - Karst Castle': LocationData(23), 
        'Bellflower - Karst Castle': LocationData(26),
        ...
        'Ivory Bug 1 - Karst Castle': LocationData(74, ivory_bug=True),
        'Ivory Bug 2 - Karst Castle': LocationData(75, ivory_bug=True),
